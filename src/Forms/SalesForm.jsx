...
const SalesForm = () => {
  return (
    <div className="form_box ">
      <div className="form_box_header d-flex justify-content-end">
        <Row>
          <Col md={4}>
      ...
      <div className="form_box_inner d-flex">
        <div className="form_box_left ">
          <div className="form_box_content">
            <Row className="form_box_content_first_row my-4 ">
              <Col md={4} xs={12}>
        ...
        <div className="form_box_right">
          <div className="form_box_content">
            ...
            <Row className="my-3">
              ...
              <Col md={6}>
                {" "}
                <Form.Label id="Paid_amount">Paid Amount</Form.Label>
                <Form.Control type="number"></Form.Control>
              </Col>
              <Col md={6}>
                {" "}
                <Form.Label id="Bal_amount">Bal Amount</Form.Label>
                <Form.Control type="number"></Form.Control>
              </Col>
            </Row>
            <Row>
